...
@JvmField val BASE_CONTENT_URI: Uri = Uri.parse("content://$CONTENT_AUTHORITY")
...
object CityWeatherEntry {
    ...
    @JvmField val CONTENT_URI: Uri = Uri.withAppendedPath(BASE_CONTENT_URI, PATH_CITIES_WEATHER)
